        ...
        <div className='singleHotel'>
            ...
            <div className="hotelContainer">
                {open && <div className="slider">
                    ...
                    <FontAwesomeIcon icon={faCircleArrowLeft} className="arrow" onClick={() => { handleMove("l", sliderNumber) }} />
                    <div className="sliderWrapper">

                        <img src={photos[sliderNumber].src} alt="" className='sliderImg' />
                    </div>
                    <FontAwesomeIcon icon={faCircleArrowRight} className="arrow" onClick={() => { handleMove("r", sliderNumber) }} />
                ...
                <div className='hotelDetails'>
                    ...
                    <span className='addessDesc'>Excellent location – 500m from center</span>
                    <span className='addessHighLight'> Book a stay over $114 at this property and get a free airport taxi</span>
                </div>
                <div className="hotelImgWrapper">
                    {
                        photos.map((photo, i) =>
                            <div className="hotelImg" key={photo.src} onClick={() => handleSlider(i)}>
